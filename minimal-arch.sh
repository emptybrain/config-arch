...
sudo pacman -S --noconfirm sddm i3-gaps picom btop htop seahorse lxappearance alacritty
...
sudo pacman -S --noconfirm google-chrome visual-studio-code-bin kitty btrfs-assistant zsh feh 
sudo pacman -S --noconfirm ripgrep exa lazygit  font-manager libgnome-keyring github-desktop
